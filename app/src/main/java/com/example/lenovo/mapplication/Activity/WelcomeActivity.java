...
import com.example.lenovo.mapplication.JavaUtils.PrefManager;
    ...
    ViewPager.OnPageChangeListener viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
        ...
        public void onPageSelected(int position) {
            ...
            if (position == layouts.length - 1) {
                btnNext.setImageResource(R.mipmap.nextbtn);
//                btnNext.setVisibility(View.VISIBLE);
            } else {

                btnNext.setImageResource(R.mipmap.nextbtn3);
            }
        }
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            AlertDialog.Builder alertbBuilder = new AlertDialog.Builder(WelcomeActivity.this);
            alertbBuilder.setTitle("提示").setMessage("您要退出车凤凰吗？").setPositiveButton("确定", new DialogInterface.OnClickListener() {
